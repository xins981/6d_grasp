...
def train_one_epoch():
    ...
    for batch_idx, batch_data_label in enumerate(TRAIN_DATALOADER):
        ...
        # input_pts = batch_data_label['point_clouds'].cpu().numpy()
        # input_clr = batch_data_label['cloud_colors'].cpu().numpy()
        # input_pcd = toOpen3dCloud(input_pts[0], input_clr[0])
        # o3d.io.write_point_cloud("input_pcd.ply", input_pcd)
        ...
        batch_interval = 10
        if (batch_idx+1) % batch_interval == 0 and LOCAL_RANK == 0:
