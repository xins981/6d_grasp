...
python test.py --dump_dir logs/dump_rs_spotr/202310062321_encode_bg_infer_only_obj \
--checkpoint_path logs/log_rs_spotr/202310062321_encode_bg_infer_only_obj/checkpoint_epoch_13.tar \
