...
python test.py --dump_dir logs/dump_rs_spotr/202310051619_encode_bg_infer_only_obj --checkpoint_path logs/log_rs_spotr/202310051619_encode_bg_infer_only_obj/checkpoint.tar --camera realsense --dataset_root data/Benchmark/graspnet
