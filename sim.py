...
net.to(device)
# Load checkpoint
checkpoint_dir = "logs/log_rs_spotr/202309121010_rm_bg/checkpoint.tar"
...
for i in range(3):
    ...
    pcd_scene, o3d_scene, info = env.reset()
    ...
    while num_scene < 15 and terminated == False:
        ...
        pcd_scene, o3d_scene, terminated, info = env.step(nms_gg)
